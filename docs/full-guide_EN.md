...
Default schedule: Every weekday at **19:00 (Beijing Time)** automatic execution.
...
| `SCHEDULE_TIME`         | Scheduled execution time          | `19:00`  |
...
schedule:
  ...
  - cron: '0 11 * * 1-5'   # Monday to Friday 19:00 (Beijing Time)
```
...
```bash
# Start scheduled mode (default 19:00 execution)
python main.py --schedule

# Or use crontab
crontab -e
# Add: 0 19 * * 1-5 cd /path/to/project && python main.py
```
